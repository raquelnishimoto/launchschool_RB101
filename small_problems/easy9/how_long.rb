=begin
Problem: Write a method that takes a string as an argument,
and returns an Array that contains every word from the string,
to which you have appended a space and the word length

Input: string

Output: new object type array

Algorithm:
split string where there is a space
iterate through the words (map)
interpolate word and word.size
